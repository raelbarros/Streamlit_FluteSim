...
#     # "title": "Collision rate",
#     "xlabel": "Launch rate (drones/min)",
#     "ylabel": "Successful trip duration (s)",
#     "categories": ["4", "6", "12"], 
#     "series": {
...
fig.update_layout(
    ...
    legend=dict(
        title="",
        font=dict(
            size=25  # Define o tamanho do texto da legenda
        ),
        x=1.02,  # Posiçao horizontal dentro do gráfico (0 é a esquerda, 1 é a direita)
